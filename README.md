...
本项目旨在对比不同TTS（文本转语音）模型在音色克隆方面的效果。主要比较了六种TTS技术：
- **IndexTTS**: [GitHub项目地址](https://github.com/index-tts/index-tts)
- **Index-TTS-1.5**: [GitHub项目地址](https://github.com/index-tts/index-tts)
...
| Index-TTS-1.5 | [合成结果](TTS/Index-TTS-1.5/基于GPU生成/en-cn-indextts1_5.wav) |
